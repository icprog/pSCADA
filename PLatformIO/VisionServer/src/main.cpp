  ...
  if(gsmCount==7)
  {
   ...
   if(gsmCount==8)
   {
    SIM900.println("AT+HTTPACTION=0");//submit the request
      delay(1000);//the delay is very important, the delay time is base on the return from the website, if the return datas are very large, the time required longer.
